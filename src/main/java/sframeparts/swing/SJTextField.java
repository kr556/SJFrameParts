...
public class SJTextField extends JTextField implements MouseListener, MouseMotionListener {
    ...
    public SJTextField setSJSize(int w, int h) {
        setSize(w,h);
        return this;
    }
    public SJTextField setSJSize(Dimension d) {
        setSize(d);
        return this;
    }
    public SJTextField setSJBounds(int x, int y, int w, int h) {
        setBounds(x,y,w,h);
        return this;
    }
    public SJTextField setSJBounds(Rectangle r) {
        setBounds(r);
        return this;
    }
    public SJTextField setSJLayout(BorderLayout b) {
        setLayout(b);
        return this;
    }
    public SJTextField setSJBackground(Color c) {
        setBackground(c);
        return this;
    }
    public SJTextField setSJVisible(boolean b) {
        setVisible(b);
        return this;
    }
    public SJTextField setSJBorder(Border b) {
        setBorder(b);
        return this;
    }
    public SJTextField setSJOpaque(boolean b) {
        setOpaque(b);
        return this;
    }
    public SJTextField setSJText(String text) {
        setText(text);
        return this;
    }
    public SJTextField setSJFont(Font f) {
        setFont(f);
        return this;
    }

    public SJTextField addSJ(Component com) {
        add(com);
        return this;
    }
    /**
     ...
     */
    public SJTextField addKeepColor(Color c) {
     ...
     * @param c         Anything color.
     */
    public SJTextField addKeepColor(String colorName, Color c) {
        if (colorName.equals("")) {
            colorNameID.add(String.valueOf(keepColor.size()));
            keepColor.put(String.valueOf(keepColor.size()), c);
        } else {
