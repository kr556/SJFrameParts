...
public class SJLabel extends JLabel implements MouseListener, MouseMotionListener {
    ...
    public SJLabel setSJSize(int w, int h) {
        setSize(w,h);
        return this;
    }
    public SJLabel setSJSize(Dimension d) {
        setSize(d);
        return this;
    }
    public SJLabel setSJBounds(int x, int y, int w, int h) {
        setBounds(x,y,w,h);
        return this;
    }
    public SJLabel setSJBounds(Rectangle r) {
        setBounds(r);
        return this;
    }
    public SJLabel setSJLayout(BorderLayout b) {
        setLayout(b);
        return this;
    }
    public SJLabel setSJBackground(Color c) {
        setBackground(c);
        return this;
    }
    public SJLabel setSJVisible(boolean b) {
        setVisible(b);
        return this;
    }
    public SJLabel setSJBorder(Border b) {
        setBorder(b);
        return this;
    }
    public SJLabel setSJOpaque(boolean b) {
        setOpaque(b);
        return this;
    }
    public SJLabel setSJText(String text) {
        setText(text);
        return this;
    }
    public SJLabel setSJFont(Font font) {
        setFont(font);
        return this;
    }
    public SJLabel setSJHorizontalAlignment(int alignment) {
        setHorizontalAlignment(alignment);
        return this;
    }

    public SJLabel addSJ(Component com) {
        add(com);
        return this;
    }
    /**
     ...
     */
    public SJLabel addKeepColor(Color c) {
     ...
     * @param c         Anything color.
     */
    public SJLabel addKeepColor(String colorName, Color c) {
        if (colorName.equals("")) {
            colorNameID.add(String.valueOf(keepColor.size()));
            keepColor.put(String.valueOf(keepColor.size()), c);
        } else {
